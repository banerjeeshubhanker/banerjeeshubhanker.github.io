...
- <b>Bias-Variance Tradeoff</b>:
  ...
  - <b>Mathematical Formulation</b>:
    - The error of a model can be decomposed as:
        ...
        $$
          \mathcal{Error} = \mathcal{Bias}^2 + \mathcal{Variance} + \mathcal{Irreducible Error}.
        $$
 
        $$
        \mathcal{Error} = \{f: \mathcal{Bias}^2 \to \mathcal{Y} \mid f \text{ satisfies certain properties}\},
        $$
